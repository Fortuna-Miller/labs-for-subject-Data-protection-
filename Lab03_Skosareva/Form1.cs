...
namespace Lab03_Skosareva
{
    public partial class Form1 : Form
    {
        ...
        void myShowToolTip(TextBox tB, byte[] arr)
        {
            ...
            /*
            BigInteger ihexStr = BigInteger.Parse(hexString);
            string binary = Convert.ToString((char)ihexStr, 2);
            BigInteger iBin = BigInteger.Parse(binary);*/
            ...
            toolTip1.SetToolTip(tB, olotoMEbinary);  //Convert.ToString(iBin)
        }
